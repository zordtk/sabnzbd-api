# SABnzbd-API
[SABnzbd](http://sabnzbd.org/) API client written in TypeScript licensed under the MIT. It supports all of the API calls listed in the version 3.5.0 documentation (<https://sabnzbd.org/wiki/advanced/api>). It's still under active development and I welcome issue reports and pull requests.
